...
export default function Locations() {
    return (
        <section id="hubs" className="py-12 md:py-20 lg:py-28 bg-slate-950 border-t border-slate-800">
                    ...
                    {locations.map((loc, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                <div className="bg-wheat-500/10 p-3 rounded-xl">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {loc.cities.map((city) => (
                                        <span
                                            key={city}
                                            className="px-4 py-2 bg-slate-900 rounded-xl text-sm font-medium text-slate-300 border border-slate-800"
                                        >
                                            {city}
                                        </span>
                                    ))}
